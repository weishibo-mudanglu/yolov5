...
class Model(nn.Module):
    ...
    def forward_once(self, x, profile=False):
        ...
        for m in self.model:
            ...
            feature_vis = False
            if m.type == 'models.common.BottleneckCSP' and m.i==17 and feature_vis:
                print(m.type, m.i)
                feature_visualization(x, m.type, m.i)
            if m.type == 'models.common.BottleneckCSP' and m.i==20 and feature_vis:
                print(m.type, m.i)
                feature_visualization(x, m.type, m.i)
            if m.type == 'models.common.BottleneckCSP' and m.i==23 and feature_vis:
                print(m.type, m.i)
                feature_visualization(x, m.type, m.i)
        if profile:
